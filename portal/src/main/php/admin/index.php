...
<script type="text/javascript" src="/portal/toolbar.php?format=js&amp;tab=admin"></script>
</head>
		...
		<div id="main" class="row">
			<div class="col-md-12">
				<div id="widgets" class="row">
					...
					<?php if ($admintool['weight'] < 1000) : ?>
					<div class="col-xs-6 col-sm-4 col-md-3">
						<a id="widget-<?php echo $admintool['id'] ?>" class="widget" href="<?php echo $admintool['url'] ?>" data-toggle="popover" data-content="<?php echo trim(str_replace(array('"', "\n"), array("'", ''), $admintool['details'])) ?>">
							<h2><?php echo $admintool['title'] ?></h2>
							<div class="logo">
								<img src="/portal/img/admintools/<?php echo $admintool['id'] ?>.png" alt="<?php echo $admintool['title'] ?>" />
							</div>
							<div class="caption">
								<p><?php echo $admintool['description'] ?></p>
							</div>
						</a>
					</div>
					<?php endif; ?>
