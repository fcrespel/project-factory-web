		...
		<div id="main" class="row">
			<div class="col-sm-offset-1 col-sm-10 col-md-offset-2 col-md-8">
				...
				<div id="content" class="row error">
					...
					<?php endif; ?>
					<h2>403 - Acc&egrave;s refus&eacute;</h2>
					<p class="text-danger"><strong>Vous n'avez pas l'autorisation d'acc&eacute;der &agrave; ce service.</strong></p>
					<p>Merci de v&eacute;rifier vos permissions ou revenir &agrave; la page pr&eacute;c&eacute;dente.</p>
				</div>
			</div>
		</div>
