...
<script type="text/javascript" src="/portal/toolbar.php?format=js&amp;tab=<?php echo $_GET['tab']; ?>"></script>
</head>
		...
		<div id="main" class="row">
			<div class="col-md-12">
				...
				<div id="content" class="row">
					...
					<p class="text-danger"><strong>Ce service est temporairement indisponible pour cause de maintenance.</strong></p>
					<p>Merci de renouveler votre tentative ult&eacute;rieurement.</p>
				</div>
			</div>
		</div>
